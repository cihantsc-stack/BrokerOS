...
class _Header extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Broker OS PRO', style: TextStyle(fontSize: 38, fontWeight: FontWeight.w900)),
        SizedBox(height: 6),
        Text(
          'Bugün ne yapmalıyım?',
          style: TextStyle(color: BrokerColors.primary, fontSize: 18, fontWeight: FontWeight.bold),
        ),
      ],
    );
  }
