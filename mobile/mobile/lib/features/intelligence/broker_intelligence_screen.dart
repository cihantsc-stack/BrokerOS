...
import '../../core/engine/ai_decision_engine.dart';
...
class BrokerIntelligenceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final aiDecision = AiDecisionEngine.build(stock);
      ...
      body: BrokerPage(
        child: Column(
          ...
          children: [
            ...
            _DailyDecisionCenter(decision: aiDecision),
...
class _DailyDecisionCenter extends StatelessWidget {
  final AiDecision decision;

  const _DailyDecisionCenter({required this.decision});
      ...
      child: Column(
        ...
        children: [
          const _SectionHeader(
            ...
            title: 'CROC AI Günlük Karar Merkezi',
            subtitle: 'Karar, güven, risk ve uygulanabilir işlem planı.',
          ),
          const SizedBox(height: 18),
          Wrap(
            spacing: 10,
          ...
          const SizedBox(height: 8),
          Text(
            'Birleşik skor ${decision.score}/100',
            style: const TextStyle(
              color: BrokerColors.textSoft,
              fontWeight: FontWeight.w800,
            ),
          ...
          _DecisionFact(
            ...
            value: decision.strongestReason,
          ...
          _DecisionFact(
            title: 'En Büyük Risk',
            value: decision.biggestRisk,
            icon: Icons.warning_amber_rounded,
            color: BrokerColors.orange,
          ),
          const SizedBox(height: 18),
          InteractiveGlossaryText(decision.summary),
          const SizedBox(height: 18),
          const Text(
            'Bugünün Görevleri',
            style: TextStyle(
          ...
          const SizedBox(height: 10),
          ...decision.todayMission.map(
            (item) => _MissionRow(text: item),
          ),
          const SizedBox(height: 12),
          Container(
...
class _MissionRow extends StatelessWidget {
  ...
  const _MissionRow({required this.text});
