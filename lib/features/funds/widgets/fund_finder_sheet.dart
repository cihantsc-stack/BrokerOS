...
class _FundFinderSheetState extends State<FundFinderSheet> {
  ...
  final FundIntelligenceEngine _intelligenceEngine =
      const FundIntelligenceEngine();
  final FundSuitabilityEngine _suitabilityEngine =
    ...
    try {
      ...
      final ranked = await Future.wait(
        catalog.map((fund) async {
          ...
          final intelligence = _intelligenceEngine.evaluate(metrics, kap: kap);
