...
class AiActionCenterCard extends StatelessWidget {
  ...
  String get _actionTitle {
    if (decision.decision.contains('GÜÇLÜ AL'))
      return 'Kademeli girişe hazırlan';
    if (decision.decision.contains('AL'))
      return 'Teyit gelirse işlem planını uygula';
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: _actionColor.withValues(alpha: 0.22)),
            ),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
