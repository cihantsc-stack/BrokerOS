...
class AiTimelineCard extends StatelessWidget {
  ...
  const AiTimelineCard({super.key, required this.timeline});
...
class _TimelineItem extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = step.isCritical ? BrokerColors.orange : BrokerColors.primary;
                      ...
                      children: [
                        ...
                        if (step.isCritical)
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: BrokerColors.orange.withValues(
                                alpha: 0.12,
                              ),
